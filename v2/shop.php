...
<body class="off-canvas-sidebar">
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#pablo">Boutique</a>
      </div>
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header pricing-page header-filter" style="background-image: url('assets/img/wp.jpg')">
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto mr-auto text-center">
            <h2 class="title">Accès</h2>
            <h5 class="description">Pour accèder au panel, vous disposez de deux choix ci-dessous.</h5>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 col-md-6 ml-auto mr-auto">
            <div class="card card-pricing card-plain">
              ...
              <div class="card-body">
                ...
                <p class="card-description">Infectez des serveurs sans avantages.</p>
              </div>
              <div class="card-footer justify-content-center ">
                <a href="register.php" class="btn btn-round btn-white">S'inscrire</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 ml-auto mr-auto">
            <div class="card card-pricing ">
              ...
              <div class="card-body">
                ...
                <p class="card-description">Les avantages du premium sont listés sur notre discord.</p>
              </div>
              <div class="card-footer justify-content-center ">
                <a href="https://discord.gg/sSxUDnP" class="btn btn-round btn-warning">Discord</a>
              </div>
            </div>
          </div>
        </div>
